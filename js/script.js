...
async function displayAlbums() {
    ...
    for (let index = 0; index < allas.length; index++) {
        ...
        if (element.href.includes("/songs/")) {
            ...
            cardContainer.innerHTML = cardContainer.innerHTML + `<div data-set=${folder} class="card black">
...
async function main() {
    ...
    currentSong.addEventListener("timeupdate", () => {
        ...
        songTime.innerHTML = `${secondsToMinutesSeconds(parseInt(currentSong.currentTime))}/${secondsToMinutesSeconds(parseInt(currentSong.duration))}`;
